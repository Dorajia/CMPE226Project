...
<div class="container">
  ...
  <h1>Choose card to pay or add a new card</h1>
                ...
                try {
                  ...
                  $con = new PDO("mysql:host=ec2-35-165-34-54.us-west-2.compute.amazonaws.com;dbname=eventgo","dora", "yuanyuan");
                    ...
                    foreach ($data as $row) {
                      ...
                      print "<td><button type=\"button\" class=\"btn btn-default\"><a href='paybyCard.php?cardNo=$cardNo&event_id=$event_id'>pay</a></button></td>";
