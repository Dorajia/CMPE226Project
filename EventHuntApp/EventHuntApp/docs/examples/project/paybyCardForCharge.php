...
$queryinsert = "insert into payment(cardNo,pay_purse,pay_date,payment_method,payment_for,status,fee_amount) select '$cardNo',purse.purse_ID,current_timestamp,c.card_type,'Purse','Complete','$amount' from card c, purse where purse.user = '$user_id' and c.card_No = '$cardNo' and c.purse_id = purse.purse_id;";
$queryupdate="update purse set purse.balance = purse.balance+$amount where purse.user= '$user_id';";
      ...
      <div class="panel-body">
        <table class="table table-striped">
          ...
          try {
            ...
            $query = "select pa.transaction_id,pa.pay_date,pa.cardNo,pa.fee_amount,pa.payment_for,pa.status from payment pa where pa.cardNo = '$cardNo' and pa.payment_for = 'Purse';";
