                ...
                try {
                  ...
                  $con = new PDO("mysql:host=ec2-35-165-34-54.us-west-2.compute.amazonaws.com;dbname=eventgo","dora", "yuanyuan");
                    ...
                    $con->setAttribute(PDO::ATTR_ERRMODE,
                        ...
                        $user_id = $_SESSION['user'];
                        $query = " select p.balance from purse p where p.user = :user_id ";
                    ...
                    foreach ($data as $row) {
                      ...
                      print "<td><button type=\"button\" class=\"btn btn-default\"><a href='chargepurse.php?'>charge</a></button></td>";
                ...
                try {
                  ...
                  $con = new PDO("mysql:host=ec2-35-165-34-54.us-west-2.compute.amazonaws.com;dbname=eventgo","dora", "yuanyuan");
                    ...
                    foreach ($data as $row) {
                      ...
                      print "<td><button type=\"button\" class=\"btn btn-default\"><a href='deleteCard.php?card_No=$cardNo'>delete</a></button></td>";
